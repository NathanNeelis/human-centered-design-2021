const transcriptie = [{
    ...
    {
        reader: "Espen",
        content: "This is true, this is true. So, should we start by introducing ourselves a bit?"
    },
    {
        reader: "Vasilis",
    ...
    {
        reader: "Vasilis",
        content: "Most websites don't have widgets on the right. Or we still see them but but that's not the, it's not necessary anymore."
    },
    {
        reader: "Espen",
        content: "Yeah we've changed..."
    },
    {
        reader: "Vasilis",
        content: "So I think these ideas they they they can change of course."
    },
    {
        reader: "Espen",
        content: "Yeah, they, the what a website looks like changes over time but we still have, we – everybody knows now what a website looks like. So it's changed from what it what it looked like back then with a with a sidebar widgets and stuff, but it's still there's still a fairly uniform look to it I think. And it's the expectations of us as designers and also our clients can be hard to get anything a bit different past clients and also past marketing people, with the with all the measurements and all the tests and all the, you know, perceived knowledge of no, it kind of has to work like this because what about our, you know, click through rates."
    },
    {
        reader: "Vasilis",
        content: "I'm very much looking forward to discussing some of these ideas in more more detail with you in the coming weeks. I mean this is incredible. I'm sure we will get into detail about, where should the header be?"
    },
    {
        reader: "Espen",
        content: "I can't wait to discuss that. Should we have hamburger menus?"
    },
    {
        reader: "Vasilis",
        content: "Yeah and what is a hamburger menu and where should the navigation be. Yep, very interesting questions. These are questions about real estate as well so we'll get back to the grid. So what should a grid look like. I think we will jump between print design and web design all the time just for reference because there are things out of knowledge there."
    },
    {
        reader: "Espen",
        content: "I think so yeah. And in the same way we will talk about design vs code. We'll probably have a episode where you get angry about current design, the state of current design tools."
    },
    {
        reader: "Vasilis",
    ...
    {
        reader: "Espen",
        content: "Yeah. And most interaction is the hover state and that's that's that."
    },
    {
        reader: "Vasilis",
    ...
    {
        reader: "Espen",
        content: "Yeah, I think now, the web is there for everybody in the same way, a piece of paper and a crayon is there for every print designer out there. You know, you can't – it's becoming harder to just publish something really easy. Having said that, without, without putting money in anyone's pockets, Netlify it has, for me at least done something incredible, which is when I built, I can't remember what I built, some small tests and I just wanted to share it with someone online and it was literally drag and drop from my folder to this folder and boof it was up. So there are, you know, there's maybe there's, there's... there's developments happening in that area as well."
    },
    {
        reader: "Vasilis",
        content: "Sounds like netlify reinvented FTP that's incredible!"
    },
    {
        reader: "Espen",
        content: "Exactly. FTP without the FTP software in the middle."
    },
    {
        reader: "Vasilis",
        content: "Great. I'm so much looking forward to discussing discussing all these topics in more detail. So the plan, if I understand correctly, is we will do an episode every now and then."
    },
    {
        reader: "Espen",
        content: "Yes, very strict schedule of every now and then..."
    },
    {
        reader: "Vasilis",
    ...
    {
        reader: "Espen",
        content: "No, I think I think you're covered it. We do one topic a week we talk about it, we... we try and design or create something around it. And then we keep going until we don't have the time or or we grow too old."
    },
    {
        reader: "Vasilis",
        content: "Or until we're done."
    },
    {
        reader: "Espen",
        content: "Until we're done. Yeah that's true. Yeah, maybe we'll finish the internet."
    },
    {
        reader: "Vasilis",
        content: "Yeah. Maybe we just yeah, we finished it. And we come to a conclusion after a few weeks."
    },
    {
        reader: "Espen",
        content: "That would be nice. Yeah, a couple episodes in, we sit down, we just write the final blog post that decides everything."
    },
    {
        reader: "Vasilis",
        content: "So much looking forward to this. There was one more thing. But I forgot about that. Oh, yeah. And of course, we will add a transcript of every episode. So if you don't like listening, or you cannot listen to the podcast for any reason, you can read it. And we'll see how we design that as well. Maybe we can do something clever with the transcript as well. So."
    },
    {
        reader: "Espen",
        content: "Yes maybe, really, really pale grey text on a clean background. So cool design. You know, trying to really challenge contrast a little bit."
    },
    {
        reader: "Vasilis",
        content: "Good. Yeah. Because we're pretty hard to understand anyway. So it should be hard to read as well. Right?"
    },
    {
        reader: "Espen",
        content: "Yeah I think we should match. Yeah, that's a good idea. We should match the type of typography to our accents. So that is equally challenging for everybody."
    },
    {
        reader: "Vasilis",
        content: "Excellent. Espen."
    },
    {
        reader: "Espen",
        content: "Right. Have we reached the end of the first episode Vasilis?"
    },
    {
        reader: "Vasilis",
    ...
    {
        reader: "Espen",
        content: "Excellent. Well, it's good talking to you."
    },
    {
        reader: "Vasilis",
        content: "It was really good talking to you. Looking forward to the next episode."
    },
    {
        reader: "Espen",
